...
Самый передовой модуль для обхода блокировок YouTube, Discord и других сайтов на Android. Подробный разбор — что это, почему нужен root, установка, стратегии, раздача через hotspot и ограничения — в отдельной заметке: **[[Zapret/magisk-zapret2|Zapret2 как Magisk-модуль — системный обход DPI на Android]]**. APK-менеджер и другие приложения проекта удобно ставить из [F-Droid-репозитория Zapret Apps](https://git.zapret.moe/fdroid/repo) — с автообновлением и проверкой подписи.
