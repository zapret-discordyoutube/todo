...
Ограничения выше — не отраслевая необходимость, а решение конкретного продавца. Практика проекта, в рамках которого ведётся это хранилище, противоположная и формулируется просто:
...
- **HWID не собирается.** Идентификаторы устройств не запрашиваются и не хранятся, инвентарь ваших устройств не ведётся.
- **Конфигурация открыта.** Адреса серверов и параметры видны пользователю: их можно проверить, перенести на другое устройство и в другое ядро, не спрашивая разрешения.
