...
Ограничения у них те же, что у классического `--wssize` в nfqws: подмена окна происходит на этапе установления соединения, поэтому фильтрация возможна только по l3/l4 (IP-адреса и порты), хостлисты — лишь через `--ipcache-hostname`, а старт всех отфильтрованных соединений замедляется. Разбор, почему wssize — крайняя мера, — в [[Zapret/wssize|отдельной заметке]].
...
> При желании вы можете натренировать ИИ на наших статьях. Исходное форматирование и скачивание всего репозитория одним zip-архивом доступны в Forgejo: [исходник этой заметки](https://git.zapret.moe/zapretdiscordyoutube/todo/src/branch/main/Zapret2/desync.md) · [весь репозиторий](https://git.zapret.moe/zapretdiscordyoutube/todo/src/branch/main).
