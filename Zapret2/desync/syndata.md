...
Та же проблема нулевой фазы у классического `--wssize` в nfqws — почему из-за неё wssize считается крайней мерой, разобрано в [[Zapret/wssize|отдельной заметке]].
