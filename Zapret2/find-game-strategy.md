...
- **Российское — мимо дурения.** Самый верхний профиль «Исключения (RU сайты)» (в пресетах с августа 2026 — «Исключения айпи (RU сайты)», рядом с доменным «Исключения домены (RU сайты)») держит [[ipset|ipset-списки]] российских сайтов и DNS на стратегии `pass` («ничего не делать»). По правилу [[profile#Порядок профилей важен: чем выше — тем главнее|«выше = главнее»]] он срабатывает первым — поэтому «на all-tcp ломается всё» — преувеличение: отваливаться могут в основном зарубежные сервисы, а RU-ресурсы пресет не трогает вовсе.
