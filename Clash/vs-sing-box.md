...
- **Обновляйте ядро, а не только оболочку.** Графический клиент может обновляться сам по себе, а бинарник ядра внутри — оставаться прошлогодним (подробнее — в [[Clash/clients|заметке про клиенты]]).
