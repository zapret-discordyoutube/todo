...
aliases:
  ...
  - Clash для новичка
description: "Первый запуск Clash/mihomo: установка клиента, добавление подписки, выбор узла и режима Rule, системный прокси или TUN, проверка IP и DNS-утечек."
---

> [!mirror] Резервное зеркало
> Актуальная версия этой страницы — на основной вики: [wiki.zapret.moe/Clash/03-first-run](https://wiki.zapret.moe/Clash/03-first-run)
