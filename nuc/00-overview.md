...
description: "Сертификаты Минцифры (НУЦ): откуда взялись, почему их навязывают и чем опасен корень в системе — риск перехвата HTTPS, проверка и удаление, изоляция."
---

> [!mirror] Резервное зеркало
> Актуальная версия этой страницы — на основной вики: [wiki.zapret.moe/nuc/00-overview](https://wiki.zapret.moe/nuc/00-overview)
