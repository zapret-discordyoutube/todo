...
Открой в проверяемом браузере `https://www.sberbank.ru`. На лето 2026 сайт Сбербанка работает на сертификате НУЦ (банк сам предлагает установить «сертификаты Минцифры» на [странице sberbank.ru/certificates](https://www.sberbank.ru/ru/certificates)); если банк сменит сертификат, признак перестанет работать — при сомнении проверяй издателя вручную, как описано ниже.
