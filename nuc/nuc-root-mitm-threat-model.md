...
description: "Что технически возможно, если поставить корневой сертификат НУЦ Минцифры: перехват HTTPS через ТСПУ, кража паролей и cookie, прецеденты DigiNotar и Казахстана."
---

> [!mirror] Резервное зеркало
> Актуальная версия этой страницы — на основной вики: [wiki.zapret.moe/nuc/nuc-root-mitm-threat-model](https://wiki.zapret.moe/nuc/nuc-root-mitm-threat-model)
