...
description: "Как открывать госсайты с сертификатом НУЦ Минцифры без установки корня в систему: отдельный браузер, профиль Firefox, исключения, виртуалка."
---

> [!mirror] Резервное зеркало
> Актуальная версия этой страницы — на основной вики: [wiki.zapret.moe/nuc/safe-usage](https://wiki.zapret.moe/nuc/safe-usage)
