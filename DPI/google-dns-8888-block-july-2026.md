...
link:
description: "Разбор блокировки 8.8.8.8 по TCP 3 июля 2026: почему «умерли» VPN при живом туннеле и как починить — сменить DNS на 8.8.4.4 или увести в туннель."
---

> [!mirror] Резервное зеркало
> Актуальная версия этой страницы — на основной вики: [wiki.zapret.moe/DPI/google-dns-8888-block-july-2026](https://wiki.zapret.moe/DPI/google-dns-8888-block-july-2026)
...
- [[DPI/tspu-dns-nsdi-dnat-august-2026|Перехват DNS на ТСПУ (август 2026)]] — продолжение сюжета с другого конца: в июле у 8.8.8.8 отрезали TCP и шифрованный DNS, в августе взялись за открытый UDP и стали заворачивать его на резолверы НСДИ.
