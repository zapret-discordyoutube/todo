...
Полную настройку OpenPGP и YubiHSM Auth выполняют не кнопками, а командами в терминале. Инструмент для такого управления называется YubiKey Manager, а запускают его командой `ykman`.
