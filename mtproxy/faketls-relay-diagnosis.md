...
- Блокировка **накопительная**: эталонные hello проходят первые один-три раза, потом замолкают, причём на одном адресе обе эталонные формы замолкают в один и тот же момент. Порог зависит от маршрута.
