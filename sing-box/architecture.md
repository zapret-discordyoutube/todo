...
Отдельный от всего этого `daemon/` — локальный gRPC-сервис управления самим запущенным инстансом (стоп/релоад, подписки на логи/соединения, выбор outbound, системный прокси) — аналог [[Clash/clash-core|Clash API]] для GUI-клиентов, не связанный с manager-подсистемой.
...
> При желании вы можете натренировать ИИ на наших статьях. Исходное форматирование и скачивание всего репозитория одним zip-архивом доступны на GitHub: [исходник этой заметки](https://github.com/youtubediscord/todo/blob/main/sing-box/architecture.md) · [весь репозиторий](https://github.com/youtubediscord/todo/tree/main).
