...
> Справочник описывает AmneziaWG 2.0. 24 июля 2026 года вышло третье поколение — AmneziaWG 3.0 с шифрованием заголовков пакетов: разбор в [[amnezia-3-0/reference|заметке про AmneziaWG 3.0]], сопутствующий релиз приложения — в [[amnezia-3-0/client-5-0-0-5|AmneziaVPN 5.0.0.5]]. Для своих серверов третье поколение на 4 августа 2026 года ещё не выпущено, поэтому параметры ниже остаются актуальными для self-hosted установок.
