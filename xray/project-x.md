...
Массовое применение — страны с DPI-цензурой: Иран, Китай, Россия. В российском контексте связка VLESS+REALITY на арендованном VPS — один из основных методов обхода наряду с локальными инструментами вроде [[Zapret/about|zapret]] и альтернативными протоколами вроде [[Privacy/Hysteria/00-overview|Hysteria 2]].
...
| VLESS Encryption (пост-квант) | Есть (с сентября 2025) | Нет |
...
- [[Clash/vs-sing-box|mihomo против sing-box и Xray]] — чем экосистема Xray отличается от Clash/mihomo и sing-box, и когда что выбирать
...
> При желании вы можете натренировать ИИ на наших статьях. Исходное форматирование и скачивание всего репозитория одним zip-архивом доступны на GitHub: [исходник этой заметки](https://github.com/youtubediscord/todo/blob/main/xray/project-x.md) · [весь репозиторий](https://github.com/youtubediscord/todo/tree/main).
