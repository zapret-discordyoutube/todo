...
| [[xray/reality\|REALITY]] | Шифрование (это модификация TLS 1.3) плюс маскировку: сервер выглядит как чужой настоящий сайт и устойчив к активному зондированию | Не прячет форму трафика и не спасает от блокировки по IP/подсети |
